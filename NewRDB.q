...
updTest:{[d]
    `TestData upsert select by sym from d; };

/upd dictionary will be triggered upon incoming update from tickerplant
upd:`trade`quote`test!(updTrade;updQuote;updTest);
...
InitializeSchemas . h(".u.sub";`test;args`syms);
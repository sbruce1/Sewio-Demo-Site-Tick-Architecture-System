...
(function (definition) {
  ...
  CIQ.UI.observe = function (params) {
    ...
    Object.observe(params.obj, function (changes) {
  ...
  CIQ.UI.Layout.prototype.getChartType = function (node, chartType) {
    var activeClassName = this.params.activeClassName; // A little complexity here to consolidate two fields (aggregationType and chartType) into one
  ...
  CIQ.UI.Layout.prototype.setChartType = function (node, chartType) {
    ...
    if (aggregations[chartType]) {
      ...
      this.context.stx.setChartType(chartType); // this.context.stx.setAggregationType(null);
    }
  };
  /**
   * @memberof CIQ.UI.Layout

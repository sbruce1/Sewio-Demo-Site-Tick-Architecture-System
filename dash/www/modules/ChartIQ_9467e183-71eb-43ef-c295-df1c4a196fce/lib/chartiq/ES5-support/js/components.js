...
(function (root, factory) {
  ...
  function (_CIQ$UI$ContextTag) {
    _inherits(ShowRange, _CIQ$UI$ContextTag);
  ...
  function (_HTMLElement) {
    ...
    _createClass(ChartIQChart, [{
      ...
      key: "startChart",
      value: function startChart(engine, feed, behavior, addOns) {
      ...
      key: "configureAddOns",
      value: function configureAddOns(addOns) {
        var stx = this.stx; // Use Object.entries in case the object is not enumable like props in React

        Object.entries(addOns).forEach(function (obj) {
          var config = obj[1];
          if (!config) return; // Give each config a reference to the engine.
          // If the config is a boolean then it should ONLY be a reference to the engine

          config === true ? config = {
            stx: stx
          } : config.stx = stx;
          if (CIQ[obj[0]] && config) new CIQ[obj[0]](config);
        });
      }
    }, {
  ...
  function (_CIQ$UI$ModalTag3) {
    ...
    _createClass(ChartTitle, [{
      ...
      value: function update() {
        ...
        var node = $(this);
        if (stx.chart.dataSet && stx.chart.dataSet.length) node.addClass("stx-show");else node.removeClass("stx-show");
    ...
    _createClass(Comparison, [{
      ...
      value: function renderLegend() {
        ...
        for (var s in stx.chart.series) {
          ...
          if (this.loading[series.parameters.symbolObject.symbol]) loader.addClass("stx-show");else loader.removeClass("stx-show");
          if (series.parameters.error) frag.attr("cq-error", true);
          if (series.parameters.permanent) btn.hide();else {
  ...
  function (_CIQ$UI$ContextTag6) {
    _inherits(Redo, _CIQ$UI$ContextTag6);
  ...
  function (_CIQ$UI$BaseComponent3) {
    _inherits(Scroll, _CIQ$UI$BaseComponent3);
    ...
    function Scroll() {
      ...
      _this8 = _possibleConstructorReturn(this, _getPrototypeOf(Scroll).call(this));
      _this8.node = $(_assertThisInitialized(_this8));
      return _this8;
    }
  ...
  function (_CIQ$UI$ContextTag7) {
    _inherits(ShareButton, _CIQ$UI$ContextTag7);
  ...
  function (_CIQ$UI$DialogContent4) {
    _inherits(ShareDialog, _CIQ$UI$DialogContent4);
  ...
  function (_CIQ$UI$ContextTag8) {
    _inherits(SidePanel, _CIQ$UI$ContextTag8);
    ...
    function SidePanel() {
      ...
      _this9 = _possibleConstructorReturn(this, _getPrototypeOf(SidePanel).call(this));
      _this9.callbacks = [];
  ...
  function (_CIQ$UI$ContextTag9) {
    _inherits(Studies, _CIQ$UI$ContextTag9);
  ...
  function (_CIQ$UI$DialogContent7) {
    ...
    _createClass(StudyDialog, [{
      ...
      value: function open(params) {
        ...
        params.panelSelect = this.hasAttribute("cq-study-panel"); // Generate a "helper" which tells us how to create a dialog
  ...
  function (_CIQ$UI$ModalTag5) {
    ...
    _createClass(StudyLegend, [{
      ...
      value: function renderLegend() {
        ...
        CIQ.I18N.translateUI(null, this.node[0]); //this.context.resize();
  ...
  function (_CIQ$UI$BaseComponent4) {
    _inherits(StudyOutput, _CIQ$UI$BaseComponent4);
  ...
  function (_CIQ$UI$ContextTag10) {
    _inherits(StudyParameter, _CIQ$UI$ContextTag10);
  ...
  function (_HTMLElement3) {
    _inherits(Swatch, _HTMLElement3);
    ...
    function Swatch() {
      ...
      _this10 = _possibleConstructorReturn(this, _getPrototypeOf(Swatch).call(this));
      /**
  ...
  function (_CIQ$UI$DialogContent9) {
    _inherits(ThemeDialog, _CIQ$UI$DialogContent9);
  ...
  function (_CIQ$UI$BaseComponent5) {
    _inherits(ThemePiece, _CIQ$UI$BaseComponent5);
  ...
  function (_CIQ$UI$ContextTag11) {
    _inherits(Themes, _CIQ$UI$ContextTag11);
  ...
  function (_CIQ$UI$DialogContent10) {
    _inherits(TimezoneDialog, _CIQ$UI$DialogContent10);
  ...
  function (_CIQ$UI$ContextTag12) {
    _inherits(Toggle, _CIQ$UI$ContextTag12);
  ...
  function (_CIQ$UI$ContextTag13) {
    _inherits(DrawingToolbar, _CIQ$UI$ContextTag13);
  ...
  function (_CIQ$UI$ContextTag14) {
    _inherits(Undo, _CIQ$UI$ContextTag14);
    ...
    function Undo() {
      ...
      _this11 = _possibleConstructorReturn(this, _getPrototypeOf(Undo).call(this));
      _this11.redoButton = null;
      _this11.undostack = [];
      _this11.redostack = [];
      _this11.contexts = [];
      return _this11;
  ...
  function (_CIQ$UI$DialogContent11) {
    _inherits(ViewDialog, _CIQ$UI$DialogContent11);
  ...
  function (_CIQ$UI$ContextTag15) {
    _inherits(Views, _CIQ$UI$ContextTag15);
  ...
  function (_CIQ$UI$Dialog) {
    ...
    function ColorPicker() {
      ...
      _this12 = _possibleConstructorReturn(this, _getPrototypeOf(ColorPicker).call(this));
      _this12.params = {
  ...
  function (_CIQ$UI$Scroll) {
    ...
    function MenuDropDown() {
      ...
      _this13 = _possibleConstructorReturn(this, _getPrototypeOf(MenuDropDown).call(this));
      _this13.noMaximize = true;
      return _this13;
    }
